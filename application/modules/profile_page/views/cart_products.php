  ...
  <div id="main"><!--main begin-->
        ...
        <div class="row" style="margin-top:5px;margin-bottom:5px;">
          ...
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
             <input type="file" class="filestyle" data-input="false" name="fileToUpload" id="fileToUpload">
          </div>
          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
            
          </div>
          <button type="submit"  value="Change pic" class="btn btn-warning">Upload</button>
          </form>
        </div>
    ...
    <div class="tab-content"><!--tabs content begin    -->
        ...
        <div id="b_right" style="right: 22px;    top: 250px;">
