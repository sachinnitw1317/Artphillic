...
<div class="col-xs-24 col-sm-24 col-md-24"><!--13 columns begin -->
  ...
  <div class="col-sm-5">
  <img src="<?php echo base_url(); ?>/images/flaticon/details/b_director.png" style="width:200px;">
  <h3 style="text-align:center;">Director</h3>
    <nav class="nav-sidebar">
    <ul class="nav tabs">
          <li class="active"><a href="#tab1" data-toggle="tab">About</a></li>
          <li class=""><a href="#tab2" data-toggle="tab">Highest Rated directors</a></li>
...
<div class="tab-pane active text-style" id="tab1">
  <h3>Courtsey:wikipedia</h3>
       <p>
        An director (actress is sometimes used for females; see § Terminology) is a person portraying a character in a dramatic or comic production; he or she performs in film, television, theatre, radio, commercials or music videos.director, ὑποκριτής (hypokrites), literally means "one who interprets";an director, then, is one who interprets a dramatic character.Method acting is an approach in which the director identifies with the portrayed character by recalling emotions or reactions from his or her own life. Presentational acting refers to a relationship between director and audience, whether by direct address or indirectly by specific use of language, looks, gestures or other signs indicating that the character or director is aware of the audience's presence. In representational acting, "directors want to make us 'believe' they are the character; they pretend."
       </p>
       
</div>
<div class="tab-pane text-style" id="tab2">
  <h3>Highest Rated directors</h3>
