...
class Portfolio extends MX_Controller {
	...
	public function get_data(){
	 ...
	 public function upload_text(){
	 	...
	 	$this->mdl_portfolio->update($data['query']);
	 }
	...
	public function auto(){
		...
		$data['query']=$this->mdl_portfolio->get_info($id);
	...
	public function load_user(){
		...
		if($id==$_SESSION['username']){
			...
			if($this->mdl_portfolio->check_user($id)){
