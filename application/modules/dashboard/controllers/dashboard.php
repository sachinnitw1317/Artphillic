...
class Dashboard extends MX_Controller {
	...
	public function get_data(){
		...
		$data['query']=$this->mdl_dashboard->data($following);
	 ...
	 public function upload_text(){
	 	...
	 	$this->mdl_dashboard->update($data['query']);
	 }
	...
	public function auto(){
		...
		$data['query']=$this->mdl_dashboard->get_info($id);
	...
	public function load_user(){
		...
		if($id==$_SESSION['username']){
			...
			if($this->mdl_dashboard->check_user($id)){
