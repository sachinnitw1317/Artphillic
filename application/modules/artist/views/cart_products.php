...
<div class="col-xs-24 col-sm-24 col-md-24"><!--13 columns begin -->
  ...
  <div class="col-sm-5">
  <img src="<?php echo base_url(); ?>/images/flaticon/details/b_artist.png" style="width:200px;">
  <h3 style="text-align:center;">Actor</h3>
    <nav class="nav-sidebar">
    <ul class="nav tabs">
          <li class="active"><a href="#tab1" data-toggle="tab">About</a></li>
          <li class=""><a href="#tab2" data-toggle="tab">Highest Rated Actors</a></li>
