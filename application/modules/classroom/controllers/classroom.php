...
class Classroom extends MX_Controller {
	...
	public function get_data(){
	 ...
	 public function upload_text(){
	 	...
	 	$this->mdl_classroom->update($data['query']);
	 }
	...
	public function auto(){
		...
		$data['query']=$this->mdl_classroom->get_info($id);
	...
	public function load_user(){
		...
		if($id==$_SESSION['username']){
			...
			if($this->mdl_classroom->check_user($id)){
