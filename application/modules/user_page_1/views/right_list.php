...
<?php $to=$this->uri->segment(3);?>
					<div class="row">
					  	<div class="col-xs-24 col-sm-24 col-md-24">
					  		<button type="button" class="btn btn-default " data-toggle="collapse" data-target="#message_box" id="but" style="margin-top:10px;"
					  	  ...
					  	  <div >
						  		...
						  		<div class="row" style="max-height:230px; overflow-y:scroll;overflow-x:hidden;padding:7px;" >
						  			<div id="msg">
