 ...
 <div id="profile" class="col-lg-24">
<div id="learn_online" class="well col-lg-12">
<div id="text_online">
  Learn Online
  </div>
  <?php 
...
<button type="submit" name="Inspire" value="">Inspire</button>
...
<div id="learn_offline"class="well col-lg-12">
<div id="text_offline">
  Learn Offline
  </div>
  <?php
