...
type="button"><a href="'.base_url().'my_followers">Follower</a>&nbsp <span class="badge">'.$query->num_rows().'</span></button>';
foreach ($query->result() as $key) {
	echo '<div class="col-sm-6 col-md-6" >
	<a href="http://localhost/artphilic/profile_page/load_user/'.$key->follower.'">
			    <img src="'.base_url().'/images/profile_pic/'.$CI->get_pic($key->follower).'" alt="image" width="100%" height="50px" style="padding:4px;">
		 </a>
	    </div>';
}
echo "</div>";
